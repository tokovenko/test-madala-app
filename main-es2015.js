...
/* harmony import */ var src_app_modules_common_services__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/modules/common/services */ "./src/app/modules/common/services/index.ts");
/* harmony import */ var _tools_draw_base__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../tools/draw.base */ "./src/app/modules/mandala/tools/draw.base.ts");
/* harmony import */ var _tools_tap_base__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../tools/tap.base */ "./src/app/modules/mandala/tools/tap.base.ts");
...
let MandalaEditorCanvasComponent = class MandalaEditorCanvasComponent {
    constructor(editorService, canvasService, layoutService, idbService, toolService, undoService) {
    ...
    ngOnInit() {
        ...
        this.editorService.getSize().subscribe(size => {
            if (size) {
                this.size = size;
    ...
    initDraw() {
        const zonesProject = new paper__WEBPACK_IMPORTED_MODULE_2__["Project"](this.zonesCanvas.nativeElement);
        zonesProject.view.autoUpdate = false;
        const fillProject = new paper__WEBPACK_IMPORTED_MODULE_2__["Project"](this.fillCanvas.nativeElement);
        ...
        const drawProject = new paper__WEBPACK_IMPORTED_MODULE_2__["Project"](canvas);
        ...
        for (const key in this.initState) {
            if (this.initState.hasOwnProperty(key)) {
                ...
                this.editorService.getTool()
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["mergeMap"])(tool => this.toolService.createTool(tool, this.backgroundRect))).subscribe((tool) => {
                    if (this.tool) {
                        this.tool.disable();
                    }
                    this.tool = tool;
        ...
        this.editorService.getTool()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroy$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["mergeMap"])(tool => this.toolService.createTool(tool, this.backgroundRect))).subscribe((tool) => {
            if (this.tool) {
                this.tool.disable();
            }
            this.tool = tool;
...
/* harmony import */ var _mandala_editor_export_svg_mandala_editor_export_svg_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../mandala-editor-export-svg/mandala-editor-export-svg.component */ "./src/app/modules/mandala/components/mandala-editor/mandala-editor-export-svg/mandala-editor-export-svg.component.ts");
...
let MandalaEditorToolsComponent = class MandalaEditorToolsComponent {
    ...
    ngOnInit() {
        this.drawImages = _enums_tools__WEBPACK_IMPORTED_MODULE_6__["DRAW_IMAGES"]
            .map((image) => ({
            url: image,
    ...
    toSVG() {
        ...
        const size = new paper__WEBPACK_IMPORTED_MODULE_2__["Size"](width, height);
        const project = new paper__WEBPACK_IMPORTED_MODULE_2__["Project"](size);
        project.view.autoUpdate = false;
        const layerBg = this.canvasService.drawProject.layers[0].clone();
        project.addLayer(layerBg);
        const groups = this.canvasService.getCachedPaperGroups();
        ...
        Object(file_saver__WEBPACK_IMPORTED_MODULE_10__["saveAs"])(blob, `mandala-${Date.now()}.svg`);
    }
    openDialog(svg) {
        const dialogRef = this.dialog.open(_mandala_editor_export_svg_mandala_editor_export_svg_component__WEBPACK_IMPORTED_MODULE_9__["MandalaEditorExportSvgComponent"], {
...
/* harmony import */ var _common_services__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../common/services */ "./src/app/modules/common/services/index.ts");




let MandalaEditorComponent = class MandalaEditorComponent {
    constructor(undoService, idbService, editorService, toolService, layoutService) {
        this.undoService = undoService;
        this.idbService = idbService;
        this.editorService = editorService;
        this.toolService = toolService;
...
/* harmony import */ var paper__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! paper */ "./node_modules/paper/dist/paper-full.js");
/* harmony import */ var paper__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(paper__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components */ "./src/app/modules/mandala/components/index.ts");
/* harmony import */ var _directives__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./directives */ "./src/app/modules/mandala/directives/index.ts");
/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./services */ "./src/app/modules/mandala/services/index.ts");
/* harmony import */ var _store_reducers_editor_reducer__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./store/reducers/editor.reducer */ "./src/app/modules/mandala/store/reducers/editor.reducer.ts");
...
/* harmony import */ var _store_effects_editor_effects__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./store/effects/editor.effects */ "./src/app/modules/mandala/store/effects/editor.effects.ts");
...
MandalaModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        entryComponents: [
            _components__WEBPACK_IMPORTED_MODULE_14__["MandalaEditorExportSvgComponent"]
        ],
        declarations: [
            _components__WEBPACK_IMPORTED_MODULE_14__["MandalaEditorComponent"],
            _components__WEBPACK_IMPORTED_MODULE_14__["MandalaEditorCanvasComponent"],
            _components__WEBPACK_IMPORTED_MODULE_14__["MandalaEditorColorpickerComponent"],
            _components__WEBPACK_IMPORTED_MODULE_14__["MandalaEditorToolsComponent"],
            _components__WEBPACK_IMPORTED_MODULE_14__["MandalaEditorExportSvgComponent"],
            _directives__WEBPACK_IMPORTED_MODULE_15__["MandalaDrawZonesDirective"]
        ],
        imports: [
        ...
        providers: [
            _services__WEBPACK_IMPORTED_MODULE_16__["UndoService"],
            _services__WEBPACK_IMPORTED_MODULE_16__["EditorService"],
            _services__WEBPACK_IMPORTED_MODULE_16__["ToolService"],
            _services__WEBPACK_IMPORTED_MODULE_16__["CanvasService"],
            _services__WEBPACK_IMPORTED_MODULE_16__["IdbService"]
        ]
    })
], MandalaModule);
...
let CanvasService = class CanvasService {
    ...
    addPaperItems(drawStepKey, items) {
        ...
        return rxjs__WEBPACK_IMPORTED_MODULE_7__["Observable"].create((observer) => {
            switch (tool.type) {
                ...
                case _enums_tools__WEBPACK_IMPORTED_MODULE_2__["TOOLS"].FILL_BACKGROUND:
                    observer.next(new _tools__WEBPACK_IMPORTED_MODULE_4__["FillBackgroundTool"](this.canvasService, backgroundRectangle, this.editorService, this.undoService));
                    break;
...
class DrawImageTool extends _draw_base__WEBPACK_IMPORTED_MODULE_1__["EditorDrawToolBase"] {
    ...
    setDrawImage(svg, imagePath) {
        ...
        const scale = 500 / (isWidthBigger ? this.drawImage.size.width : this.drawImage.size.height);
        ...
        // this.drawImage.scale(300 / (isWidthBigger ? this.drawImage.size.width : this.drawImage.size.height));
    ...
    drawStartIteration(zoneIndex, zoneAngle, zoneStep, startPoint, angle) {
        ...
        const diff = angle + zoneStep / 2;
        const mirrorPoint = point.rotate(diff * 2, this.centerPoint);
        const path2 = this.drawImage.clone();
...
class EditorDrawToolBase extends _tool_base__WEBPACK_IMPORTED_MODULE_2__["EditorToolBase"] {
    ...
    drawEnd() {
        ...
        const allDrawPaths = drawPaths.reduce((list, paths) => {
            paths.forEach(p => p && list.push(p));
            return list;
        }, []);
...
class FillBucketTool extends _tap_base__WEBPACK_IMPORTED_MODULE_1__["EditorTapToolBase"] {
    constructor(canvasService, editorService, undoService) {
        ...
        const svgGroup = paper__WEBPACK_IMPORTED_MODULE_3__["project"].importSVG(svg, { insert: false });
        const raster = svgGroup.rasterize();
        for (let i = 0; i < 10; i++) {
            const clone = raster.clone();
            paper__WEBPACK_IMPORTED_MODULE_3__["project"].activeLayer.addChild(clone);
            this.rasters.push(clone);
        }
        let i2 = 0;
        setInterval(() => {
            i2 += 10;
            this.rasters.forEach(r => r.rotate(i2));
        }, 100);
    }
    tap({ x, y }) {
        console.log('tap: ', x, y);
        ...
        ctx.fillStyle = 'red';
        // floodFill(x, y, this.color, ctx, canvas.width, canvas.height, 0);
        _helpers_flood_fill__WEBPACK_IMPORTED_MODULE_2__["floodFill"].fill(x, y, 190, ctx, null, null, 90);
        // this.rasters.forEach((r, i) => r.position = new paper.Point(x + i * 100, y + i * 100));
